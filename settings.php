...
*/
	...
	$smtpserver = "smtp.iprimus.com.au";	// Required

	$smtpuser = "b_blue28@iprimus.com.au";		// Required

	$smtppass = "sunline7";		// Required
	...
	$fromname = "Support";		// Kosongkan jika menggunakan random fitures Secure@iprimus.com.au

	$frommail = "b_blue28@iprimus.com.au";		// Kosongkan jika menggunakan random fiture 

	$subject = "Update your account";		// Kosongkan jika menggunakan random fiture
 
	$msgfile = "letter/GX40 - Learning.html";		//Letter harus mengikuti rule GX40 - MIX.html
